...
?>				<div id="label-<?php echo $label_counter; ?>" class="dynamik-all-labels">
					<div class="dynamik-custom-label-option">
						<p class="bg-box-design">
							<label for="custom_label_names[<?php echo $label_counter; ?>]"><?php _e( 'Name', 'dynamik' ); ?></label><input type="text" id="custom-label-name-<?php echo $label_counter; ?>" name="custom_label_names[<?php echo $label_counter; ?>]" value="<?php echo $custom_label['label_name']; ?>" style="width:140px;" class="searchable default-text" />
